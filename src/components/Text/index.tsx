...
const Text = () => {
  return (
    <div className='xl:w-[1300px] lg:w-[90%] m-auto sm:mt-20 mt-10 border-b border-zinc-300 pb-10'>
            ...
            <div className='grid sm:grid-cols-3 grid-cols-1 gap-5 mt-10 m-3 s:m-0'>
               <Image src={solo1} alt='solo1' className=" shadow-2xl shadow-black rounder-lg h-[300px] object-cover w-full"/>
               <Image src={solo2} alt='solo2' className=" shadow-2xl shadow-black rounder-lg h-[300px] w-full"/>
               <Image src={solo3} alt='solo3' className=" shadow-2xl shadow-black rounder-lg h-[300px] object-cover w-full"/>
            </div>
            <Slider />
    </div>
  )
