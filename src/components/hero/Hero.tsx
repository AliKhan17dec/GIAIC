...
const Hero = () => {
  return (
    <div className={` relative z-0 w-full overflow-hidden bg-opCITY-75 bg-[url('/bg_house.jpg')] bg-cover ${poppins.className}`}>
      ...
      <div className=" z-50 m-auto mt-6 block w-[95%] items-center justify-between md:flex md:flex-row lg:w-[90%] xl:w-[1300px]">
        ...
        <h1 className="whitespace-nowrap text-center text-[1.5rem] font-normal leading-[2rem] tracking-wider text-main sm:4xl sm:leading-[3rem] md:text-left lg:text-[2.5rem]">Kamran Khan Tessori</h1>
        <h1 className="mt-5 whitespace-nowrap text-center text-[1.5rem] font-semibold leading-[2rem] tracking-wider text-sub sm:text-4xl sm:leading-[3rm] md:text-left lg:text-[2,5rem]">
          Certified Cloud
          <br />
        ...
        <div className="mb-7 mt-5 flex flex-cols items-center sm:mt-10 sm:flex-row sm:gap-5 md:mb-0">
